...
const Keypad: React.FC<KeypadProps> = ({ onInsert, onClear, onCalculate, onBackspace, mode }) => {
  ...
  return (
    <div className="flex flex-col gap-3 p-4 pb-8 bg-slate-100 dark:bg-slate-950 rounded-t-[2rem] transition-colors">
      ...
      <div className="grid grid-cols-4 gap-3">
        {/* Row 1 */}
        <button onClick={onClear} className={acBtn}>AC</button>
        <button onClick={onBackspace} className={actionBtn}>
           {/* Backspace Icon */}
